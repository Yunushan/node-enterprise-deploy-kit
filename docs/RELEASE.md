...
pack, bundle, coverage, artifact import, release workflow, and release
readiness self-tests once per CI run, so release evidence stays verified
without making every static job repeat the same long checks.
