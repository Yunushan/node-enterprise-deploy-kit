...
| 502 from IIS/Nginx | Reverse proxy alive but Node backend down | Restart service and check Node logs |
...
| PM2 list is empty | PM2 is not managing the app | Use WinSW/systemd or fix PM2 process definition |
