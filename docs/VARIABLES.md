...
| Next.js require package provenance | `NextjsRequirePackageProvenance` | `NEXTJS_REQUIRE_PACKAGE_PROVENANCE` | Require a kit-generated, safe Next.js package marker and reject a package built for a different OS, CPU architecture, Linux libc family, or Node native-module ABI before the active app directory is replaced |
