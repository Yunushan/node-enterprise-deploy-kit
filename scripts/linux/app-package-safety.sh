...
package_safety_zip_metrics() {
  # Match data rows by their typed date/time fields. Info-ZIP emits ISO dates
  # on some images and locale-neutral MM-DD-YYYY dates on others; the footer
  # separator has neither shape.
