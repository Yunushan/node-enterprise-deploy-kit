...
foreach ($expected in @(
    ...
    '$DisplayName must be a relative .json path inside the repository workspace.',
    '$DisplayName must reference a tracked repository file.',
    "matrix_path was not found on the self-hosted runner workspace.",
    ...
    "evidence_name must match expected support dimensions",
