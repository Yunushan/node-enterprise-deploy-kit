...
$releaseReadinessSnippets = @(
  ...
  'same `-MatrixPath` used for coverage, bundling, and',
  "sourceControl.isGitRepository",
  "sourceControl.commitSha",
  "generatedAtUtc",
  "supportMatrix.sha256",
  "supportMatrix.targetCount",
  "supportMatrix.requiredMinimumUptimeHours",
  "supportMatrix.runtimeSupportTiers",
  "maxEvidenceAgeDays",
  "releaseClaim.requirements.maxEvidenceAgeDaysRequired",
  "matrixSha256",
  'manifest `matrixPath`',
  "bundleCi.provider",
  ...
  "uniqueEvidenceSha256Count",
  "productionRecommendedRuntimeEvidenceCount",
  "runtimeSupportTiers",
  "safe claim requirements",
  "workflow applicability metadata",
  "runtime support metadata",
  "strict CI full-matrix claim kind",
  "bundleSupportScope.proofLevel",
  "bundleSupportScope target counts",
  "bundleSupportScope.workflowCapableEvidenceCount",
  "bundleSupportScope.localCommandOnlyEvidenceCount",
  ...
  "coverage.requiredMinimumUptimeHours",
  "bundleSupportScope.requiredMinimumUptimeHours",
...
$requiredDocSnippets += @(
  @{
    Path = "docs/HOST_VERIFICATION.md"
    Snippets = @(
      "installed Next.js package version",
      "active runtime folder",
      "node_modules/next/package.json"
    )
  },
  @{
    Path = "docs/NEXTJS_DEPLOYMENT.md"
    Snippets = @(
      "installed Next.js package version",
      "active runtime folder",
      "node_modules/next/package.json",
