...
$requiredFiles = @(
  ...
  "scripts/linux/app-package-lifecycle.sh",
  "scripts/linux/app-package-safety.sh",
  "scripts/linux/test-post-deploy-health.sh",
  "scripts/linux/deployment-lock.sh",
  "scripts/linux/rollback-app-package-transaction.sh",
